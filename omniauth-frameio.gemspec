...
require_relative "lib/omniauth/frameio/version"

Gem::Specification.new do |spec|
  spec.name = "omniauth-frameio"
  spec.version = Omniauth::Frameio::VERSION
  spec.authors = ["Victor Holl"]
  spec.email = ["v_h@me.com"]

  spec.summary = "Omniauth strategy for Frame.io"
  spec.homepage = "https://github.com/boxprod/omniauth-frameio"
  spec.license = "MIT"
